...
import { Tooltip, Icon, Input, Button, Col, Form } from "antd";
            ...
            >
              {getFieldDecorator("nickname", {
                rules: [
                  {
                    required: true,
                    message: "vui long nhập họ tên của bạn!",
                    whitespace: true
                  }
                ]
              })(<Input />)}
...
const mapDispatchToProps = dispatch => ({
  postRegister: (body, callback) => dispatch(registerAction(body, callback))
});
